...
document.addEventListener('DOMContentLoaded', () => {
    let PHRASES = {
      ...
      "industryTemplates": {
        "通用": { "talk": "营收稳定，企业经营情况较好；现金回笼节奏与采购/销售匹配，主要指标稳健。" },
      ...
      "lexicon": {
        "structure": {
          "collateral": {
          "不动产抵押": "以不动产抵押为主，抵押率控制在合理区间。",
            "信用": "信用方式，以企业经营现金流作为核心还款来源，企业发展前景较好。",
            "default": "以{gb}为主要担保措施。"
          },
          "use": {
            "企业经营周转": "用于企业经营周转，资金用途不得流向限制性领域。",
            "default": "用于{use}，资金用途明确，符合我行信贷管理政策要求。"
          }
        },
      ...
      "incomePlans": [
        {"id":"A","label":"主办结算","text":"以我行作为主办结算行，提升结算与客户粘性。"},
        {"id":"B","label":"代发与代缴","text":"落地工资代发与代扣代缴，形成稳定沉淀与费收。"},
        ...
        {"id":"F","label":"科技/绿色专属","text":"重点支持领域，匹配科技债或绿债资金，获取政策性成本优势。"}
      ],
